...
model.fit(X_train, y_train, epochs=1000, verbose=1, callbacks=my_callbacks, validation_data=(X_test, y_test))

eval_result = model.evaluate(X_test, y_test)

model.save('/home/user/Desktop/GIT/abhi-jha/keras-pluralsight-tutorial/my_model')
